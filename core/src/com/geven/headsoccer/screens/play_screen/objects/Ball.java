...
public class Ball {
    ...
    public Ball(){
        ...
        bodyDef.position.set(2040 / 2 / PPM, (1360 - 190 - 35) / PPM);  //50

        //Shape definition:
        shape = new CircleShape();
        shape.setRadius(35 / PPM);  //50
        ...
        fixtureDef.filter.maskBits = SPRITE_HOME | SPRITE_OUT | COLLISION;

        ball = PlayScreen.getWorld().createBody(bodyDef);
        ball.createFixture(fixtureDef);
        AssetLoader.spriteBall.setSize(70 / PPM, 70 / PPM); //100
